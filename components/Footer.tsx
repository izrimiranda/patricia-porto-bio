  ...
  return (
    <footer className="w-full mt-12 mb-6 text-center space-y-3 pt-4 border-t border-stone-200">
      ...
      <div className="flex items-center justify-center gap-2 text-xs text-stone-400">
        <a href="https://codigo1615.com.br" target="_blank" rel="noopener noreferrer" className="hover:text-stone-600 transition-colors uppercase tracking-wider font-semibold">Código 1615</a>
